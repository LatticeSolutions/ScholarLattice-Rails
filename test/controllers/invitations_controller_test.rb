...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference("Invitation.count") do
      post invitations_url, params: { invitation: { collection_id: @invitation.collection_id, profile_id: @invitation.profile_id, status: @invitation.status } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { collection_id: @invitation.collection_id, profile_id: @invitation.profile_id, status: @invitation.status } }
